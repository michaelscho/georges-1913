...
def load_model(repo_id="mschonhardt/georges-1913-normalization-model"):
    global vocab  # To ensure it's accessible in the forward pass
...
def normalize_string(input_str, model, vocab, device):
    with torch.no_grad():
